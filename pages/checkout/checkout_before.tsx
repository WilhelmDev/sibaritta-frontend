    ...
    // <SecurityPrivileges>
      ...
      <div className="container-general  main-page checkoutContenedor">
        ...
        <div className="flex space-x-4 gap-4">
            ...
            <div className="order_summary">
              <div className="order_datos  flex flex-col  items-start pb-0">
                <div className="experincie-date-box ">
                  ...
                  <h5 className="txt-experincie-date-box  text-[#F89C53] font-bold">
                    ...
                    datos.sugerencias.map((bebida: any) => (
                      <div key={bebida.id} className="order_box-box_main ">
                        ...
                        <button
                          ...
                          className="w-[90%] h-[3rem] bg-[#4D3452]  rounded-[1rem] text-[#E1D4C4]  text-[1.4rem] font-bold tablet:hidden"
                        >
                          Modificar
                        </button>
                      </div>
          ...
          text-[#E1D4C4]  text-[1.4rem] font-bold "
                      >
                        Modificar
                      </button>
                    </div>
              ...
              <article className="order_experiencie border-none">
                ...
                {/* <button
                    onClick={openModalPropina}
                    className="w-[11.3rem] h-[3rem] bg-[#4D3452]  rounded-[1rem] text-[#E1D4C4]  text-[1.4rem] font-bold tablet:hidden"
                  >
                    Modificar
                  </button> */}
                {/* </div> */}
