...
import SideBarPerfil from "../organisms/SideBarPerfil";
...
export const Navbar: FC<NavbarProps> = ({ isMenuOpen, closeMenu }) => {
  ...
  const polylang = {
    menu: [
      ...
      {
        id: 3,
        label: "Sibaritta Business ",
        url: "/sibaritta_business",
      },
      {
        id: 4,
        label: "Contactanos",
  ...
  const half = 4;
  const menuPartOne = [...polylang.menu].slice(0, 1);
