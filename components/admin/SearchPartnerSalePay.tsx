...
function SearchPartnerSalePay({ infoData, select, setpartId }: any) {
  ...
  return (
    <div className="flex justify-center items-center SearchPartnerSalePay">
...
export default SearchPartnerSalePay;
